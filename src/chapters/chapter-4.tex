...
Mesin AMD menggunakan laptop dengan spesifikasi AMD Ryzen 7 5800H, RAM 16 GB,
dan sistem operasi Windows 11.
Mesin Intel menggunakan laptop dengan spesifikasi %TODO: isi spesifikasi Intel i7 (model, RAM, OS).
...
PID berada di urutan kedua dengan \emph{regret} rata-rata 0{,}391.
Statik tertinggal jauh dengan \emph{regret} 2{,}919 karena tidak mampu memanfaatkan
kapasitas tambahan yang tersedia.
Pada preset Q1, LQR (3.152) lebih rendah dari PID (4.046) sebesar 22\% dan dari Statik (9.662) sebesar 67\%.
...
Polanya sama dengan konfigurasi penuh, di mana LQR memberikan biaya terendah.
Pada konfigurasi setengah, \emph{regret} Rule-Based naik menjadi 1{,}015 dibanding
konfigurasi penuh yang 1{,}160, yang menunjukkan bahwa aturan ambang batas statis
semakin kurang efektif saat kapasitas berkurang.

LQR tetap pada posisi terbaik dengan \emph{regret} 0{,}000 dan mampu menyesuaikan
\emph{batch} secara proporsional terhadap kondisi antrean meski kapasitas lebih kecil.
