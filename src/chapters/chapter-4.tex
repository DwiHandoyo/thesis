...
sampel dari 30 percobaan (6 kontroler $\times$ 5 pola beban $\times$ 1 pengulangan).
...
PID berada di urutan kedua dengan \emph{regret} rata-rata 0,146.
...
\textbf{LQR} menunjukkan pola reaktif yang jelas, di mana \emph{batch} naik saat antrean meningkat
...
(\emph{capacity benchmark}) dan normalisasi operasional.
Prosedur ini hanya memerlukan waktu sekitar 30 menit, jauh lebih singkat dibanding
...
PID berada di urutan berikutnya dengan \emph{regret} 0,146.
...
\textbf{LQR tetap dapat menyesuaikan diri dengan kapasitas yang berbeda.}
Nilai $B[\text{queue}, \text{batch}]$ pada LQR mencerminkan perubahan relatif antrean
terhadap perubahan \emph{batch}, bukan nilai kapasitas absolut, sehingga LQR tetap
dapat bekerja meskipun kapasitas sistem berubah.
...
PID juga relatif stabil karena gain integralnya dapat mengakumulasi error lebih cepat
